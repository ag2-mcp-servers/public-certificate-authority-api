...
from models import Alt, ExternalAccountKey, FieldXgafv
...
app = MCPProxy(
    ...
    version='v1beta1',
    servers=[{'url': 'https://publicca.googleapis.com/'}],
)


@app.post(
    '/v1beta1/{parent}/externalAccountKeys',
